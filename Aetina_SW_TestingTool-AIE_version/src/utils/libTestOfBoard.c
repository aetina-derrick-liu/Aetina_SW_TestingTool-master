...
DeviceInfo* TOB_GetDeviceInfo(DeviceInfo *devinfo_result){
	...
	switch(GetModuleType()){
		case TX2_NX:
			devinfo_result->pModule = malloc(strlen("TX2-NX")*sizeof(char));
			strcpy(devinfo_result->pModule, "TX2-NX");
			break;		
		case TX2:
	...
	if(devinfo_result->pszDTS_Name == NULL && strlen(szResult)){
		...
		else if (strstr(szResult, "AIE-CN11")){
			devinfo_result->pszCarrierBoard = malloc(strlen("AIE-CN11") * sizeof(char));
			strcpy(devinfo_result->pszCarrierBoard, "AIE-CN11");
		}
		else if (strstr(szResult, "AIE-CN12")){
			devinfo_result->pszCarrierBoard = malloc(strlen("AIE-CN12") * sizeof(char));
			strcpy(devinfo_result->pszCarrierBoard, "AIE-CN12");
		}
		else if (strstr(szResult, "AIE-CN13")){
			devinfo_result->pszCarrierBoard = malloc(strlen("AIE-CN13") * sizeof(char));
			strcpy(devinfo_result->pszCarrierBoard, "AIE-CN13");
		}
		else if (strstr(szResult, "AIE-CN14")){
			devinfo_result->pszCarrierBoard = malloc(strlen("AIE-CN14") * sizeof(char));
			strcpy(devinfo_result->pszCarrierBoard, "AIE-CN14");
		}
		else if (strstr(szResult, "AIE-CT41")){
			devinfo_result->pszCarrierBoard = malloc(strlen("AIE-CT41") * sizeof(char));
			strcpy(devinfo_result->pszCarrierBoard, "AIE-CT41");
			strcpy(devinfo_result->pszDTS_Name,strstr(devinfo_result->pszDTS_Name,dtsName));
			strcpy(devinfo_result->pszDTS_Name,devinfo_result->pszDTS_Name+11);
		}
		else if (strstr(szResult, "AIE-CT42")){
			devinfo_result->pszCarrierBoard = malloc(strlen("AIE-CT42") * sizeof(char));
			strcpy(devinfo_result->pszCarrierBoard, "AIE-CT42");
			strcpy(devinfo_result->pszDTS_Name,strstr(devinfo_result->pszDTS_Name,dtsName));
			strcpy(devinfo_result->pszDTS_Name,devinfo_result->pszDTS_Name+11);
		}
		else if (strstr(szResult, "AIE-CT43")){
			devinfo_result->pszCarrierBoard = malloc(strlen("AIE-CT43") * sizeof(char));
			strcpy(devinfo_result->pszCarrierBoard, "AIE-CT43");
			strcpy(devinfo_result->pszDTS_Name,strstr(devinfo_result->pszDTS_Name,dtsName));
			strcpy(devinfo_result->pszDTS_Name,devinfo_result->pszDTS_Name+11);
		}
		else if (strstr(szResult, "AIE-CT44")){
			devinfo_result->pszCarrierBoard = malloc(strlen("AIE-CT44") * sizeof(char));
			strcpy(devinfo_result->pszCarrierBoard, "AIE-CT44");
			strcpy(devinfo_result->pszDTS_Name,strstr(devinfo_result->pszDTS_Name,dtsName));
			strcpy(devinfo_result->pszDTS_Name,devinfo_result->pszDTS_Name+11);
		}		
		else if (strstr(szResult, "AIE-CO11")){
			devinfo_result->pszCarrierBoard = malloc(strlen("AIE-CO11") * sizeof(char));
			strcpy(devinfo_result->pszCarrierBoard, "AIE-CO11");
		}
		else if (strstr(szResult, "AIE-CO12")){
			devinfo_result->pszCarrierBoard = malloc(strlen("AIE-CO12") * sizeof(char));
			strcpy(devinfo_result->pszCarrierBoard, "AIE-CO12");
		}
		else if (strstr(szResult, "AIE-CO13")){
			devinfo_result->pszCarrierBoard = malloc(strlen("AIE-CO13") * sizeof(char));
			strcpy(devinfo_result->pszCarrierBoard, "AIE-CO13");
		}
		else if (strstr(szResult, "AIE-CO14")){
			devinfo_result->pszCarrierBoard = malloc(strlen("AIE-CO14") * sizeof(char));
			strcpy(devinfo_result->pszCarrierBoard, "AIE-CO14");
		}		
		else {
...
int GetModuleType(){
	...
	if (chip_id == TX2_ID){
		...
		while(fgets(szResult, MAX_PATH, pf_dts)){
			...
			else if (strstr(szResult, "AIE_CT")){
				return TX2_NX;
			}				
		...
		while(fgets(szResult, MAX_PATH, pf_dts)){
			...
			else if(strstr(szResult, "AIE-CN")){
				return XAVIER_NX;
			}
		}
	}
...
int TOB_USB_Testing(USB_CFG *usb_cfg, USB_RESULT *usb_result){
						...
						case USB_3_0_TYPE_A:
							{
								...
								//2nd
								//USB3.0
								else if(strstr(szResult, usb_cfg->pUSB_2nd_TYPE_A_UP_USB3DEV) || strstr(szResult, usb_cfg->pUSB_2nd_TYPE_A_DOWN_USB3DEV)){
									nType = USB_3_0;									
									// nPortPosition = strstr(szResult, usb_cfg->pUSB_3_0_TYPE_A_UP_USB3DEV) ? UP : DOWN;
									bFind = true;
								}
								//USB 2.0
								else if(strstr(szResult, usb_cfg->pUSB_2nd_TYPE_A_UP_USB2DEV) || strstr(szResult, usb_cfg->pUSB_2nd_TYPE_A_DOWN_USB2DEV)){
									nType = USB_2_0;									
									// nPortPosition = strstr(szResult, usb_cfg->pUSB_3_0_TYPE_A_UP_USB2DEV) ? UP : DOWN;z
									bFind = true;
								}
								//3rd
								//USB3.0
								else if(strstr(szResult, usb_cfg->pUSB_3rd_TYPE_A_UP_USB3DEV) || strstr(szResult, usb_cfg->pUSB_3rd_TYPE_A_DOWN_USB3DEV)){
									nType = USB_3_0;									
									// nPortPosition = strstr(szResult, usb_cfg->pUSB_3_0_TYPE_A_UP_USB3DEV) ? UP : DOWN;
									bFind = true;
								}
								//USB 2.0
								else if(strstr(szResult, usb_cfg->pUSB_3rd_TYPE_A_UP_USB2DEV) || strstr(szResult, usb_cfg->pUSB_3rd_TYPE_A_DOWN_USB2DEV)){
									nType = USB_2_0;									
									// nPortPosition = strstr(szResult, usb_cfg->pUSB_3_0_TYPE_A_UP_USB2DEV) ? UP : DOWN;z
									bFind = true;
								}
								//4th
								//USB3.0
								else if(strstr(szResult, usb_cfg->pUSB_4th_TYPE_A_UP_USB3DEV) || strstr(szResult, usb_cfg->pUSB_4th_TYPE_A_DOWN_USB3DEV)){
									nType = USB_3_0;									
									// nPortPosition = strstr(szResult, usb_cfg->pUSB_3_0_TYPE_A_UP_USB3DEV) ? UP : DOWN;
									bFind = true;
								}
								//USB 2.0
								else if(strstr(szResult, usb_cfg->pUSB_4th_TYPE_A_UP_USB2DEV) || strstr(szResult, usb_cfg->pUSB_4th_TYPE_A_DOWN_USB2DEV)){
									nType = USB_2_0;									
									// nPortPosition = strstr(szResult, usb_cfg->pUSB_3_0_TYPE_A_UP_USB2DEV) ? UP : DOWN;z
									bFind = true;
								}
	...
	if(usb_result->nResultNum != usb_cfg->nInterfaceNum){
		return NOT_FOUND_DEVICE;
	}
	else{
